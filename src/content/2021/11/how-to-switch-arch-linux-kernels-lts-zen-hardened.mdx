export const title = "How to Switch Arch Linux Kernels"
export const description = "Learn how to install and switch between Arch Linux kernels including Stable, LTS, Zen, and Hardened using pacman and GRUB configuration."

export const date = "2021-11-22"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux", "Distros", "Arch"]
export const cover = "/docs-static/img/2021/11/how-to-switch-arch-linux-kernels-lts-zen-hardened/cover.jpg"
