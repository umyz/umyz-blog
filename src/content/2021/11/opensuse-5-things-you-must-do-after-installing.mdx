export const title = "OpenSUSE – 5 Things You MUST Do After Installing"
export const description = "Get started with openSUSE by following five essential post-install steps including Packman repos, Snapper backups, codecs, YaST configuration, and Flatpak."

export const date = "2021-11-10"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "OpenSUSE", "Linux", "Distros"]
export const cover = "/docs-static/img/2021/11/opensuse-5-things-you-must-do-after-installing/cover.jpeg"
