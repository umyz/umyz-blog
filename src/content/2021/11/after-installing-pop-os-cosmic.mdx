export const title = "5 Things You MUST DO after Installing Pop!_OS"
export const description = "Get started with Pop!_OS COSMIC by following these five essential post-install steps including updates, backups, media codecs, and app recommendations."

export const date = "2021-11-13"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux", "Distros", "Pop!_OS"]
export const cover = "/docs-static/img/2021/11/after-installing-pop-os-cosmic/cover.jpg"
