export const title = "Monitor AMD RYZEN Temps in Linux"
export const description = "Monitor CPU temperatures on Linux using lm_sensors and Psensor, with installation instructions for Ubuntu, Debian, Arch, and Fedora."

export const date = "2021-11-15"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux", "Hardware"]
export const cover = "/docs-static/img/2021/11/monitor-amd-ryzen-temps-in-linux/cover.jpg"

<YouTube videoId="llVfIswUn2k" />
...
![](/docs-static/img/2021/11/monitor-amd-ryzen-temps-in-linux/2-lm-sensors.png)
...
![](/docs-static/img/2021/11/monitor-amd-ryzen-temps-in-linux/3-psensors.png)
