export const title = "ChatGPT in YOUR Terminal"
export const description = "Use ChatGPT directly in your terminal with tgpt, a cross-platform CLI tool for Windows, macOS, and Linux that requires no API keys."

export const date = "2023-04-23"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "AI", "Terminal"]
export const cover = "/docs-static/img/2023/04/chatgpt-in-your-terminal/cover.jpg"
...
![](/docs-static/img/2023/04/chatgpt-in-your-terminal/tgpt-programing-1024x599.png)
...
![](/docs-static/img/2023/04/chatgpt-in-your-terminal/tgpt-1024x512.gif)

## Checkout our Video Demo and Testing

<YouTube videoId="Xg63xdqbA9E" />