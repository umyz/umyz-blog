export const title = "Easily Install AMD Ryzen CPU and Wraith Prism Cooler"
export const description = "Step-by-step guide to installing AMD Ryzen processors and the Wraith Prism cooler, with detailed instructions for CPU seating and cooler mounting."

export const date = "2021-11-13"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Hardware"]
export const cover = "/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/cover.jpg"
...
<YouTube videoId="alHCJAkzhsA" />

## 1\. Lift Retention Arm

![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/1-amd-retention-arm-1024x576-1.jpg)

Place the Retention Arm in the up-and-down position.

## 2\. Handle CPU with Care

![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/2-amd-ryzen-pins-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/3-amd-cpu-triangle-1024x576-1.jpg)

Locate the small white triangle on the bottom left of the CPU.

## 4\. Locate the Triangle on the Board

![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/4-amd-cpu-socket-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/5-amd-motherboard-installed-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/6-amd-retention-arm-down-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/7-amd-cooler-preinstalled-paste-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/8-amd-logo-cooler-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/9-amd-cooler-clamping-hook-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/10-amd-wriath-cooler-mobo-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/11-amd-cooler-lever-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/12-amd-level-locked-cooler-1024x576-1.jpg)

See the image above and verify you’ve completed this step.

## 13\. Connect the Fan Header

![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/13-amd-fan-header-connection-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/14-amd-rgb-usb-cable-1024x576-1.jpg)
...
![](/docs-static/img/2021/11/install-amd-ryzen-cpu-and-wraith-prism-cooler/15-amd-toms-hardware.png)
