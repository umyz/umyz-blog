export const title = "EVERYONE needs a Home Server"
export const description = "Five compelling reasons to build a home server including local backups, media streaming, DNS services, learning opportunities, and offline access."

export const date = "2025-02-01"
export const authors = ["Cameron Knauff"]
export const categories = ["Essay"]
export const tags = ["Homelab", "Essay"]
export const cover = "/docs-static/img/2025/02/5-reasons-build-home-server/cover.jpg"
...
![My Network Share on my MacBook Air](/docs-static/img/2025/02/5-reasons-build-home-server/1_network_share.jpeg)
...
![Jellyfin Demo](/docs-static/img/2025/02/5-reasons-build-home-server/2_jellyfin.png)
...
![PiHole Screenshot](/docs-static/img/2025/02/5-reasons-build-home-server/3_pihole.png)
...
![Unraid](/docs-static/img/2025/02/5-reasons-build-home-server/4_unraid.jpg)
...
![Kiwix](/docs-static/img/2025/02/5-reasons-build-home-server/5_kiwix.png)
