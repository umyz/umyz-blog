export const title = "the OFFICIAL Windows (lite) from Microsoft"
export const description = "Set up Windows 11 IoT Enterprise LTSC as a lightweight, debloated alternative with no ads, no AI bloat, and 10-year support from Microsoft."
export const date = "2025-02-03"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Windows"]
export const cover = "/docs-static/img/2025/02/windows-lite-ltsc-microsoft/cover.jpg"

<YouTube videoId="hVl9B3dTFB4" />
...
![Signin](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/1_signin.png)

Just click on Sign In Options than \-\> Domain Join instead.

![Domain Join](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/2_domain_join.png)

Also be sure to disable all the Windows telemetry in the Windows setup screen:

![Setup Telementry](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/3_telementry.png)
...
![Empty Start Menu](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/4_empty_start_menu.png)
...
![Opening Powershell](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/5_local_group_policy.png)
...
![Local Group Policy](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/6_diagnostic_data_off.png)
...
![Microsoft Store Notification](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/8_win_store_notification.png)
...
![Disabling Edge on Startup](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/9_edge_startup.png])
...
![Preformance Settings](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/10_preformance_settings.png])
...
![Accessibility Settings](/docs-static/img/2025/02/windows-lite-ltsc-microsoft/11_accessibility_settings.png)
