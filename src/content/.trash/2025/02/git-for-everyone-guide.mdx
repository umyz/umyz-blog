export const title = "Git for Everyone"
export const description = "Learn Git basics for non-developers covering cloning, commits, pushing, and GitHub workflows to manage files and collaborate on projects."

export const date = "2025-02-03T16:40:55-08:00"
export const authors = ["Scott Yeager"]
export const categories = ["Guides"]
export const tags = ["Git", "Guides", "Github"]
export const cover = "/docs-static/img/2025/02/git-for-everyone-guide/cover.jpg"
...
![](/docs-static/img/2025/02/git-for-everyone-guide/01_git-version.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/02_git-clone.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/03_git-readme.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/04_git-status.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/05_git-newfile.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/06_git-changes-committed.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/07_git-file-modified.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/08_git-log.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/09_git-new-fork.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/10_git-create-fork.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/11_github-new-token.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/12_github-token-classic.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/13_github-push-fork.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/14_github-git-config.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/15_github-chages-shown.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/16_github-history.png)

Clicking that pulls up a display that’s something like `git log`. We see the history of commits and who created them.

![](/docs-static/img/2025/02/git-for-everyone-guide/17_github-commits-log.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/18_github-commits-readme.png)
...
![](/docs-static/img/2025/02/git-for-everyone-guide/19_github-fork-states.png)
