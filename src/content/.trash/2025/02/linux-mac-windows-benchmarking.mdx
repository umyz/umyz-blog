export const title = "Benchmarking Linux, Mac AND Windows on a 2019 MacBook Pro"
export const description = "Comprehensive benchmarks comparing Ubuntu, macOS, and Windows on a 2019 MacBook Pro covering boot speed, battery life, CPU, GPU, and browser performance."

export const date = "2025-02-16"
export const authors = ["Cameron Knauff", "Brandon Hopkins"]
export const categories = ["Benchmarking"]
export const tags = ["Benchmarking", "Linux", "Windows", "Mac"]
export const cover = "/docs-static/img/2025/02/linux-mac-windows-benchmarking/cover.webp"

<YouTube videoId="l8gjYDU-GsA" />
...
<Video src="/docs-static/img/2025/02/linux-mac-windows-benchmarking/1_boot-speed.mp4" controls="yes" />
...
<Video src="/docs-static/img/2025/02/linux-mac-windows-benchmarking/2_reboot-speed.mp4" controls="yes" />
...
![Geekbench 6 Scores](/docs-static/img/2025/02/linux-mac-windows-benchmarking/4_geekbench.png)
...
![Novabench](/docs-static/img/2025/02/linux-mac-windows-benchmarking/5_novabench.png)
...
![Cinebench](/docs-static/img/2025/02/linux-mac-windows-benchmarking/7_cinebench.png)
...
![Geekbench GPU](/docs-static/img/2025/02/linux-mac-windows-benchmarking/8_geekbench_gpu.png)
...
![Valley Benchmark](/docs-static/img/2025/02/linux-mac-windows-benchmarking/9_valley.png)
...
![Basemark Web 3.0 Results](/docs-static/img/2025/02/linux-mac-windows-benchmarking/10_basemark_web.png)
...
![WebXPRT 4 results](/docs-static/img/2025/02/linux-mac-windows-benchmarking/11_webxprt.png)
