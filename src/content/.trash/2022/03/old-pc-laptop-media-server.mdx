export const title = "Turning an OLD PC/Laptop into a Media Server! (Ubuntu/PLEX Guide)"
export const description = "Transform an old PC or laptop into a media server using Ubuntu Server and Plex, with step-by-step setup for SSH, SFTP, and streaming throughout your home."

export const date = "2022-03-21"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Homelab", "PLEX"]
export const cover = "/docs-static/img/2022/03/old-pc-laptop-media-server/cover.jpg"
