export const title = "Microsoft Edge might WIN on Linux."
export const description = "Benchmark comparison of Microsoft Edge on Linux against Firefox, Chromium, Brave, Vivaldi, and GNOME Web across JavaScript, graphics, and responsiveness tests."

export const date = "2022-05-16"
export const authors = ["Brandon Hopkins"]
export const categories = ["Benchmarking"]
export const tags = ["Benchmarking", "Linux", "Apps"]
export const cover = "/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/cover.jpg"
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/1-kraken-1-1024x793-1.jpg)
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/2-jetstream-1-1024x793-1.jpg)
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/3-ares.jpg)
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/4-motionmark-1024x793-1.jpg)
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/5-speedmeter-1024x793.jpeg)
...
![](/docs-static/img/2022/05/microsoft-edge-might-win-on-linux/6-webxprt-1024x793-2.jpg)
