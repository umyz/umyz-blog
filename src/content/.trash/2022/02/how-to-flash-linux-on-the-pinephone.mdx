export const title = "How to Flash Linux on the PinePhone"
export const description = "Learn how to flash Linux distributions on your PinePhone using Jumpdrive, including Manjaro, Arch, Ubuntu Touch, and other ARM distributions."

export const date = "2022-02-13"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Mobile", "Pine64", "Hardware"]
export const cover = "/docs-static/img/2022/02/how-to-flash-linux-on-the-pinephone/cover.jpg"
