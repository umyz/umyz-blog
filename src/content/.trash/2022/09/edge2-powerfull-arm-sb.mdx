export const title = "The Edge2 Pro is a CRAZY Powerful ARM Single Board Computer"
export const description = "Review of the Khadas Edge2 Pro ARM single-board computer featuring the Rockchip RK3588S, 8K video support, and desktop-class performance benchmarks."

export const date = "2022-09-28"
export const authors = ["Brandon Hopkins"]
export const categories = ["Hardware"]
export const tags = ["Single Board Computers", "Khadas", "ARM"]
export const cover = "/docs-static/img/2022/09/edge2-powerfull-arm-sb/cover.jpg"
...
![](/docs-static/img/2022/09/edge2-powerfull-arm-sb/Edge2_Interfce-748x1024.webp)
