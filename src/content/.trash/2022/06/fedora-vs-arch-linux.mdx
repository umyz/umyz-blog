export const title = "Fedora vs Arch Linux - Battle of the Best!"
export const description = "Compare Fedora and Arch Linux across update structure, package management, repositories, and installation to help you choose the right distribution."

export const date = "2022-06-11"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Arch", "Distros", "Fedora"]
export const cover = "/docs-static/img/2022/06/fedora-vs-arch-linux/cover.jpg"
