export const title = "No, Manjaro is NOT Arch"
export const description = "Understand the key differences between Manjaro and Arch Linux, why Manjaro isn't a true Arch installer, and discover better alternatives like EndeavourOS."

export const date = "2022-07-23"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Manjaro", "Distros", "Arch"]
export const cover = "/docs-static/img/2022/07/no-manjaro-is-not-arch/cover.jpg"
...
![](/docs-static/img/2022/07/no-manjaro-is-not-arch/manjaro-intervention-update.png)
...
![](/docs-static/img/2022/07/no-manjaro-is-not-arch/plasma.jpg)
...
![](/docs-static/img/2022/07/no-manjaro-is-not-arch/manjaro-setting-manager.png)

![](/docs-static/img/2022/07/no-manjaro-is-not-arch/image-114.png)
...
![](/docs-static/img/2022/07/no-manjaro-is-not-arch/anarchy-1.0.10-installation-options.png)
