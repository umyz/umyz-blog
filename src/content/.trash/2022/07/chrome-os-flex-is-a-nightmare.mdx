export const title = "Chrome OS Flex is a NIGHTMARE!"
export const description = "An honest review of Chrome OS Flex covering installation, hardware compatibility issues, Linux app support, and why a lightweight Linux distro may be better."

export const date = "2022-07-15"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Apps", "Essay"]
export const cover = "/docs-static/img/2022/07/chrome-os-flex-is-a-nightmare/cover.jpg"
...
![](/docs-static/img/2022/07/chrome-os-flex-is-a-nightmare/chromebook-recovery-utility.png)
...
![](/docs-static/img/2022/07/chrome-os-flex-is-a-nightmare/chromeos-splash-screen.png)
