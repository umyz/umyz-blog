export const title = "7 Docker Basics for Beginners"
export const description = "Learn Docker fundamentals including installation, volumes, networking, Docker Compose, and container management for beginners getting started with containerization."

export const date = "2024-02-06"
export const authors = ["Brandon Hopkins", "Scott Yeager"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux"]
export const cover = "/docs-static/img/2024/02/7-docker-basics-for-beginners/cover.png"
...
We will use the "convenience script" for one of the easiest ways to install it on your system. Once that's done, any future updates will also be available through `apt`. Here is the command to install using the script:
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-basic-use-1024x575.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-ps-1024x187.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-kill-1024x169.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-purne-1024x363.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-bind-mounts-1024x99.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-networking.png)
...
![](/docs-static/img/2024/02/7-docker-basics-for-beginners/docker-net-host.png)
