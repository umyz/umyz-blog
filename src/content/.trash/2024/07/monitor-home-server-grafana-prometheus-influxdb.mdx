export const title = "BEST Way to Monitor your Home Server! (Grafana, Prometheus, InfluxDB)"
export const description = "Set up comprehensive home server monitoring with Grafana, Prometheus, InfluxDB, and Telegraf for visualizing system metrics across your homelab."

export const date = "2024-07-06"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Homelab", "Monitoring"]
export const cover = "/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/cover.jpg"
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/image-2-1024x417.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/unraid-data-preview-1024x522.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/prometheus.yml_.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/datasource.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/influxdb-setup-1024x785.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/influxdb-charts-1-1024x721.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/grafana-login-1024x739.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/data-sources-1024x349.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/influx-data-auth-1024x675.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/influxdb-details-1024x522.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/image-13-1024x350.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/image-16.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/image-20.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/image-19.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/unraid-prometheis-exporter.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/exporter-hosts.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/proxmox-metric-server.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/proxmox-bucket-connection-1024x290.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/proxmox-dashbboard-1024x653.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/Screenshot-from-2024-06-30-17-47-38.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/Screenshot-from-2024-06-30-17-48-03.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/flux-docker-dashboard-1024x634.png)
...
![](/docs-static/img/2024/07/monitor-home-server-grafana-prometheus-influxdb/Screenshot-2024-07-02-at-11-51-14-Unraid-System-Dashboard-V2-Dashboards-Grafana-1024x797.png)
