export const title = "COSMIC might be the future of the Linux Desktop."
export const description = "First look at System76's COSMIC desktop environment built in Rust, featuring new apps, customization options, and tiling window management for Pop!_OS."

export const date = "2024-05-26"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Desktop Environments", "Distros", "Pop!_OS"]
export const cover = "/docs-static/img/2024/05/cosmic-pre-alpha/cover.jpg"
