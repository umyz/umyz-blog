export const title = "Guide: Setting Up Windows as a NAS Operating System"
export const description = "Complete guide to setting up Windows 11 as a NAS with Storage Spaces, network shares, Wake-on-LAN, Docker Desktop, SSH, and remote access."

export const date = "2024-05-21"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Self-Host", "Windows", "Homelab"]
export const cover = "/docs-static/img/2024/05/run-windows-nas-home-server/cover.jpg"
...
3. **Download and Install Rufus**:
    ...
    - Rufus helps create bootable USB drives with additional customization options.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/rufus-settings.webp)
...
3. **Windows Installation**:
    ...
    - If necessary, delete existing partitions on the NVME drive to start with a clean slate. Select each partition of the proper drive and click "Delete".
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-6-25-screenshot.png)
...
5. **Initial Setup**:
    - After installation, if you didn't skip the user setup in Rufus, go through the basic setup, creating a local account (preferably without spaces, e.g., "admin").
...
1. **Rename the Device**:
    ...
    - Choose a recognizable name (e.g., "WinNAS").
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-7-37-screenshot.png)
...
3. **Enable Network Discovery and File Sharing**:
    ...
    - Turn on network discovery and file and printer sharing.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-8-33-screenshot.png)
...
7. **Enable Wake-on-LAN**:
    ...
    - Under the Advanced tab, enable "Wake on Magic Packet".
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-10-48-screenshot.png)
...
9. **Configure Local Group Policy**
    ...
    - Select the "Enabled" option to enable network connectivity during connected standby.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-9-55-screenshot.png)
...
- **Enabling Wake on LAN:**
    ...
    - Enable Wake on LAN for network cards to allow the system to wake up remotely.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-11-0-screenshot-e1716274845991.png)
...
- **Checking Wake-up Status:**
    - Connect to the network tab on another machine to check if the NAS responds and wakes up as expected.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-13-23-screenshot.png)

    - Verify that the NAS wakes up and is accessible on the network.

### **6\. Create a Storage Pool**

<YouTube videoId="Ipnnt6f7d4I" />
...
1. **Working with Windows Storage Spaces**
    ...
    - Choose a drive letter or mount point for the pool.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-17-39-screenshot.png)
...
3. **Fixing Common Errors: Physical Disk Sector Size**
    ...
    - Go to the "Volumes" tab and click on "Format." Follow the on-screen instructions to format the disk with a sector size of 4096 bytes.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-15-43-screenshot.png)
...
1. **Create Shared Folders**:
    ...
    - Right-click the desired folder > Properties > Sharing tab.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-19-43-screenshot.png)

    - Click "Share" and select users or groups to share with.

    - Set permissions as needed.

        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-20-34-screenshot.png)
...
- **Enabling Remote Desktop:**
    - Navigate to the system settings to enable Remote Desktop access on the NAS.
        ...
        ![](/docs-static/img/2024/05/run-windows-nas-home-server/yes.-you-CAN-use-Windows-11-as-a-home-server-but-shouldnt-13-16-screenshot-1.png)
...
<YouTube videoId="9kQ75FxxkUw" />

1. **Enable OpenSSH Server and Authentication**
