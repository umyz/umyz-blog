export const title = "The ULTIMATE RetroPie Setup Guide"
export const description = "Complete RetroPie setup guide for Raspberry Pi, covering installation, controller configuration, WiFi setup, SSH access, and ROM management via FTP."

export const date = "2022-10-19"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "RaspberryPi"]
export const cover = "/docs-static/img/2022/10/ultimate-retropie-setup-guide/cover.jpg"
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/retropi-imager.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/Resizing_RetroPie_1.3.2.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/Gamepad_Config.png)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/raspi-config_1.3.4.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/WLAN_Country_1.3.5.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/overscan_1.3.6.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/Reboot_1.3.7.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/Screen-Shot-2022-10-19-at-9.35.37-AM.png)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/Wifi_Connected_1.3.9.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/SSH_enable_1.3.10.jpg)
...
![](/docs-static/img/2022/10/ultimate-retropie-setup-guide/FTP_connect_1.3.11.jpg)
