export const title = "The Sudden Fall of JingOS and their Linux Tablet"
export const description = "The rise and sudden fall of JingOS and the JingPad A1 Linux tablet, examining what went wrong with software, pricing, and communication."

export const date = "2022-08-12"
export const authors = ["Brandon Hopkins"]
export const categories = ["Hardware"]
export const tags = ["Essay", "Mobile", "Linux"]
export const cover = "/docs-static/img/2022/08/fall-of-jingos-linux-tablet/cover.jpg"

<YouTube videoId="cmBG1Sjgsgk" />
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jing-tab.png)
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jingos-app-store-1024x576.jpg)
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jingos-flash.png)
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jingos-no-hurry.png)
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jingos-development-gone.png)
...
![](/docs-static/img/2022/08/fall-of-jingos-linux-tablet/jingling-was-ambitious.png)
