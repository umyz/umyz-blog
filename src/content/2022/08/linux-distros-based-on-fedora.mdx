export const title = "Linux Distros Based on Fedora"
export const description = "Explore Fedora-based Linux distributions including Nobara for gaming, Ultramarine, Qubes OS for security, and official Fedora Spins and Labs."

export const date = "2022-08-08"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Fedora", "Distros"]
export const cover = "/docs-static/img/2022/08/linux-distros-based-on-fedora/cover.jpg"
...
<YouTube videoId="stIndl1YuIg" />

## Nobara

![](/docs-static/img/2022/08/linux-distros-based-on-fedora/fedora-nobara.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/fedora-ultramarine.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/fedora-qubes-os.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/montana-linux.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/berry-linux.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/fedora-network-security-toolkit.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/kedora-fedora.png)
...
![](/docs-static/img/2022/08/linux-distros-based-on-fedora/fedora-offical-spins.png)
