export const title = "7 (more) AWESOME Linux Terminal CLI Applications"
export const description = "Discover seven more Linux terminal utilities including toipe, bottom, wordgrinder, micro, Midnight Commander, espeak, and asciiquarium."

export const date = "2022-05-15"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Linux", "Apps", "Terminal"]
export const cover = "/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/cover.jpg"

<YouTube videoId="cKqsw_sAsU8" />
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/2-toipe-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/1-bottom-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/3-wordgrinder-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/4-micro-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/5-mc-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/6-espeak-1536x864-1.png)
...
![](/docs-static/img/2022/05/7-more-awesome-linux-terminal-utilities/7-ascci-1536x864-1.png)
