export const title = "Perfect Windows 11 Virtual Machine on Linux (VMware Guide)"
export const description = "Set up a Windows 11 virtual machine on Linux using VMware with hardware bypass fixes for TPM requirements and 3D graphics acceleration."

export const date = "2022-03-11"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Windows", "Linux", "Virtualization"]
export const cover = "/docs-static/img/2022/03/windows-11-vmware-guide-linux/cover.jpg"
