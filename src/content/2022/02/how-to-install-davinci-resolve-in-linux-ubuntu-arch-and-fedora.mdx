export const title = "Install DaVinci Resolve in Linux (Outdated)"
export const description = "Step-by-step guide to installing DaVinci Resolve on Linux for Fedora, Ubuntu, Debian, and Arch with both NVIDIA and AMD GPU configurations."

export const date = "2022-02-13"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "DaVinci Resolve", "Linux"]
export const cover = "/docs-static/img/2022/02/how-to-install-davinci-resolve-in-linux-ubuntu-arch-and-fedora/cover.jpg"
