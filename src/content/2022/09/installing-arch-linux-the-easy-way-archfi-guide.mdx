export const title = "Installing Arch Linux the EASY WAY! – archfi Guide"
export const description = "Install Arch Linux easily using the archfi bash script, with step-by-step guidance through partitioning, package selection, and dual-boot setup."

export const date = "2022-09-26"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Arch", "Linux", "Distros"]
export const cover = "/docs-static/img/2022/09/installing-arch-linux-the-easy-way-archfi-guide/cover.jpg"
