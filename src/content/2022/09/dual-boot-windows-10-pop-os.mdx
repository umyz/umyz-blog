export const title = "How to Dual Boot Windows 10 and Pop!_OS (Legacy/GRUB)"
export const description = "Legacy BIOS guide for dual-booting Windows 10 and Pop!_OS, including disk partitioning, installation, and GRUB bootloader configuration."

export const date = "2022-09-26"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux", "Windows", "Distros", "Pop!_OS"]
export const cover = "/docs-static/img/2022/09/dual-boot-windows-10-pop-os/cover.jpg"

<YouTube videoId="EXZ7_DVxztQ" />
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/3-etcher.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/4-shrink-volume.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/5-new-part-size-1.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/6-boot-menu.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/7-custom-install.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/8-mod-partitions.png)

A GParted window will open. Right click on the unallocated space and select ‘New’.

![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/9-new-partition.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/10-create-new.png)
...
![](/docs-static/img/2022/09/dual-boot-windows-10-pop-os/11-use-partition.png)
