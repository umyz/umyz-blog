export const title = "How to make ZIP Files in Windows"
export const description = "Learn how to create ZIP files in Windows using built-in tools or 7-Zip for better compression, encryption, and password protection features."

export const date = "2022-09-04"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Windows", "Computing Basics"]
export const cover = "/docs-static/img/2022/09/how-to-make-zip-files-in-windows/cover.jpg"

import {YouTube} from "@/components/YouTube"

<YouTube videoId="78dc2qX7GpQ" />
...
![](/docs-static/img/2022/09/how-to-make-zip-files-in-windows/send-to-zip-in-windows.jpg)
...
![](/docs-static/img/2022/09/how-to-make-zip-files-in-windows/zip-file-2.jpg)
