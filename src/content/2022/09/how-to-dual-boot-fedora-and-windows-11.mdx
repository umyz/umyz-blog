export const title = "How to Dual Boot Fedora and Windows 11"
export const description = "Complete guide to dual-booting Fedora and Windows 11 with UEFI, including partitioning, Secure Boot, clock sync fixes, and GRUB customization."

export const date = "2022-09-16"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Linux", "Distros", "Windows", "Fedora"]
export const cover = "/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/cover.jpg"
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/power-plan-windows.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/disable-fast-start-windows.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/windows-disk-managment.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/windows-shrink-volume.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/windows-shrink-disk-space.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/disable-secure-boot.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/bios-boot-options-1.png)

Finally, we can save and exit the bios settings.

![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/bios-save-and-exit-1.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/install-fedora-setting-1.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/fedora-disk-options.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/clock-issues-fedora.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/fedora-setdatectl.png)
...
![](/docs-static/img/2022/09/how-to-dual-boot-fedora-and-windows-11/grub-customizer.png)
