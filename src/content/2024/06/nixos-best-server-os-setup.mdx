export const title = "NixOS - The New Best Server OS?"
export const description = "Get started with NixOS as a server operating system, featuring declarative configuration, easy rollbacks, SSH setup, and Docker deployment."

export const date = "2024-06-13"
export const authors = ["Brandon Hopkins"]
export const categories = ["Guides"]
export const tags = ["Guides", "Homelab", "Linux", "Distros", "NixOS"]
export const cover = "/docs-static/img/2024/06/nixos-best-server-os-setup/cover.jpg"
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/Install-welcome-1024x632.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/DE-selection-1024x640.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/Installing-1024x649.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/first-login.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/image-1.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/rebuild-for-sshd.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/image.png)

To also disable password based logins, add a line like this one:

![](/docs-static/img/2024/06/nixos-best-server-os-setup/disable-password-based-auth.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/docker-enabled.png)

Per the wiki page, I'll also add myself to the \`docker\` user group by adding an entry to my groups list:

![](/docs-static/img/2024/06/nixos-best-server-os-setup/docker-user.png)
...
![](/docs-static/img/2024/06/nixos-best-server-os-setup/docker-working.png)
