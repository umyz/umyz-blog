export const title = "MUST HAVE Homelab Services"
export const description = "Explore essential homelab services for 2025 including Plex, Jellyfin, the *arr stack, Immich, Home Assistant, Pi-hole, Grafana, and more."
export const date = "2025-03-11"
export const authors = ["Brandon Hopkins"]
export const categories = ["Software"]
export const tags = ["Homelab", "Docker", "Self-Host"]
export const cover = "/docs-static/img/2025/03/must-have-home-server-services-2025/cover.png"
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/00_proxmox.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/01_glace-dashboard.png)

**Resources:** [Video](https://youtu.be/QGONe-NTWuI) | [Github](https://github.com/glanceapp/glance)

### Homarr

<YouTube videoId="A6vcTIzp_Ww" />
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/02_file-browser.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/03_vaultwarden-password-manager.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/04_hoarder-bookmark-manager.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/05_portainer-docker-manager.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/06_cockpit-server-tool.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/07_octoprint-3d-printing.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/08_jellyfin-media-server.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/09_plex-media-server.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/10_tautulli-plex-stats.png)
...
<YouTube videoId="Uzqf0qlcQlo" />

### Overseerr

![](/docs-static/img/2025/03/must-have-home-server-services-2025/11_overseerr-media-reuests.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/12_radarr-movie-management.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/13_sonarr-shows-management.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/14_lidarr-music-management.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/15_prowlarr-index-manager.png)
...
[![](/docs-static/img/2025/03/must-have-home-server-services-2025/airvpn.png)](https://airvpn.org/?referred_by=673908)

### qBittorrent

![](/docs-static/img/2025/03/must-have-home-server-services-2025/16_qbittorrent-peer-client.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/17_nzbget-newsletter-client.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/18_nextcloud-cloud.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/19_immich-photo-backup.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/20_docmost-personal-wiki.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/21_home-assistant-smart.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/22_frigate-nvr.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/23_zigbee2mqtt-smart-devices.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/24_pi-hole-dns-sinkhole.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/25_nginx-proxy-manager.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/26_cloudflare-ddns.png)
...
<YouTube videoId="vffhtqK3ZU" />

### Grafana

![](/docs-static/img/2025/03/must-have-home-server-services-2025/27_grafana-dashboards.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/28_teslamate-grafana.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/29_influxdb2-data-explorer.png)
...
![](/docs-static/img/2025/03/must-have-home-server-services-2025/30_proetheus-query-execute.png)
